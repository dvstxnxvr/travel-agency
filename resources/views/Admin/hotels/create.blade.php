...
<div class="bg-white rounded-lg shadow">
    ...
    <form method="POST" action="{{ route('admin.hotels.store') }}" class="p-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                <div class="mb-4">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 @error('name') border-red-500 @enderror">
                    @error('name') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
                
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Страна *</label>
                    <input type="text" name="country" value="{{ old('country') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 @error('country') border-red-500 @enderror">
                    @error('country') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
                
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Город *</label>
                    <input type="text" name="city" value="{{ old('city') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 @error('city') border-red-500 @enderror">
                    @error('city') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
                
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Адрес *</label>
                    <input type="text" name="address" value="{{ old('address') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 @error('address') border-red-500 @enderror">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <select name="star_rating" class="w-full border border-gray-300 rounded-lg px-3 py-2">
                            <option value="1" {{ old('star_rating') == 1 ? 'selected' : '' }}>1 звезда</option>
                            <option value="2" {{ old('star_rating') == 2 ? 'selected' : '' }}>2 звезды</option>
                            <option value="3" {{ old('star_rating') == 3 ? 'selected' : '' }}>3 звезды</option>
                            <option value="4" {{ old('star_rating') == 4 ? 'selected' : '' }}>4 звезды</option>
                            <option value="5" {{ old('star_rating') == 5 ? 'selected' : '' }}>5 звезд</option>
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="room_count" value="{{ old('room_count', 50) }}" class="w-full border border-gray-300 rounded-lg px-3 py-2">
            ...
            <div>
                <div class="mb-4">
                    ...
                    <input type="text" name="contact_phone" value="{{ old('contact_phone') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 @error('contact_phone') border-red-500 @enderror">
                    @error('contact_phone') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
                
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Email *</label>
                    <input type="email" name="email" value="{{ old('email') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 @error('email') border-red-500 @enderror">
                    @error('email') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
                
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Веб-сайт</label>
                    <input type="url" name="website" value="{{ old('website') }}" placeholder="https://..." class="w-full border border-gray-300 rounded-lg px-3 py-2">
                </div>
                
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Время заезда *</label>
                        <input type="text" name="check_in_time" value="{{ old('check_in_time', '14:00') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="check_out_time" value="{{ old('check_out_time', '12:00') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 p-4 bg-gray-50 rounded-lg">
                ...
                @foreach($amenitiesList as $amenity)
                    <label class="flex items-center space-x-2">
                        <input type="checkbox" name="amenities[]" value="{{ $amenity }}" class="rounded border-gray-300">
        ...
        <div class="mb-4">
            ...
            <textarea name="description" rows="6" class="w-full border border-gray-300 rounded-lg px-3 py-2 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
        ...
        <div class="mt-6 flex justify-end space-x-3 pt-4 border-t">
            ...
            <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                <i class="fas fa-save mr-2"></i>Создать отель
            </button>
        </div>
    </form>
</div>
